...
```text
github.com/franwerner/gentle-ai/v3/internal/update/upgrade.releaseMinisignPublicKeys
```
...
- With Go 1.25.10+ on `PATH`, the built-in upgrader runs
  `go install github.com/franwerner/gentle-ai/v3/cmd/gentle-ai@vX.Y.Z`,
