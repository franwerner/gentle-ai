...
**Record-store carve-out.** Architecture and design decisions are exempt from the save order above — they belong to the openrecord record store, not to Engram. No other save trigger is affected.
...
- **Record-store carve-out.** Architecture and design decisions are exempt from
  the save order above — they belong to the openrecord record store, not to
  Engram. No other save trigger is affected.
