...
`)
	...
	want := strings.Join([]string{
		"github.com/franwerner/gentle-ai/v3,example.com/private",
		"github.com/franwerner/gentle-ai/v3,github.com/acme/*",
		"github.com/franwerner/gentle-ai/v3",
	}, "\n")
	if got != want {
...
func TestWindowsInstallScriptBetaGoInstallPreservesGoProxyBypassEnv(t *testing.T) {
	...
	for _, clobber := range []string{
		"$env:GONOSUMDB = \"github.com/franwerner/gentle-ai/v3\"",
		"$env:GOPRIVATE = \"github.com/franwerner/gentle-ai/v3\"",
		"$env:GONOPROXY = \"github.com/franwerner/gentle-ai/v3\"",
	} {
		if strings.Contains(script, clobber) {
