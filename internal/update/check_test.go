...
func TestCheckSingleToolGentleAIBetaComparesMainHead(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		switch r.URL.Path {
		case "/repos/franwerner/gentle-ai/releases/latest":
			json.NewEncoder(w).Encode(githubRelease{TagName: "v1.40.3", HTMLURL: "https://github.com/franwerner/gentle-ai/releases/tag/v1.40.3"})
		case "/repos/franwerner/gentle-ai/commits/main":
			json.NewEncoder(w).Encode(githubCommit{SHA: "972997650b51abcdef0123456789abcdef012345", HTMLURL: "https://github.com/franwerner/gentle-ai/commit/972997650b51abcdef0123456789abcdef012345"})
		default:
...
func TestCheckSingleToolGentleAIPseudoVersionComparesMainHeadWithoutChannel(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case "/repos/franwerner/gentle-ai/releases/latest":
			json.NewEncoder(w).Encode(githubRelease{TagName: "v1.40.3", HTMLURL: "https://github.com/franwerner/gentle-ai/releases/tag/v1.40.3"})
		case "/repos/franwerner/gentle-ai/commits/main":
			json.NewEncoder(w).Encode(githubCommit{SHA: "b6872c69e3e4abcdef0123456789abcdef012345", HTMLURL: "https://github.com/franwerner/gentle-ai/commit/b6872c69e3e4abcdef0123456789abcdef012345"})
		default:
			// Stray or misdirected request: reply 404 and let the test's
			// main-goroutine assertions decide (see simulateStrayForeignRequest).
			http.NotFound(w, r)
...
func TestCheckSingleToolGentleAIStableVersionWithoutChannelComparesLatestRelease(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		switch r.URL.Path {
		case "/repos/franwerner/gentle-ai/releases/latest":
			json.NewEncoder(w).Encode(githubRelease{TagName: "v1.40.4", HTMLURL: "https://github.com/franwerner/gentle-ai/releases/tag/v1.40.4"})
		case "/repos/franwerner/gentle-ai/commits/main":
	...
	if result.ReleaseURL != "https://github.com/franwerner/gentle-ai/releases/tag/v1.40.4" {
...
func TestCheckSingleToolGentleAIBetaAcceptsLocalCommitPrefix(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case "/repos/franwerner/gentle-ai/releases/latest":
			json.NewEncoder(w).Encode(githubRelease{TagName: "v1.40.3", HTMLURL: "https://github.com/franwerner/gentle-ai/releases/tag/v1.40.3"})
		case "/repos/franwerner/gentle-ai/commits/main":
			json.NewEncoder(w).Encode(githubCommit{SHA: "6eff4a1ba110abcdef0123456789abcdef012345", HTMLURL: "https://github.com/franwerner/gentle-ai/commit/6eff4a1ba110abcdef0123456789abcdef012345"})
		default:
			// Stray or misdirected request: reply 404 and let the test's
			// main-goroutine assertions decide (see simulateStrayForeignRequest).
			http.NotFound(w, r)
...
func TestCheckSingleToolGentleAIBetaHintNamesAdvertisedTarget(t *testing.T) {
	...
	if result.UpdateHint != "go install github.com/franwerner/gentle-ai/v3/cmd/gentle-ai@main" {
...
func TestCheckSingleToolGentleAIBetaNewerLocalPseudoVersionIsNotOffered(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case "/repos/franwerner/gentle-ai/commits/main":
			...
			fmt.Fprint(w, `{"sha":"aaaabbbbcccc0123456789abcdef0123456789ab","html_url":"https://github.com/franwerner/gentle-ai/commit/aaaabbbbcccc0123456789abcdef0123456789ab","commit":{"committer":{"date":"2026-07-25T10:00:00Z"}}}`)
		default:
			// Stray or misdirected request: reply 404 and let the test's
			// main-goroutine assertions decide (see simulateStrayForeignRequest).
			http.NotFound(w, r)
...
func TestCheckSingleToolGentleAIBetaOlderLocalPseudoVersionStillOffered(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case "/repos/franwerner/gentle-ai/releases/latest":
			json.NewEncoder(w).Encode(githubRelease{TagName: "v1.40.3", HTMLURL: "https://github.com/franwerner/gentle-ai/releases/tag/v1.40.3"})
		case "/repos/franwerner/gentle-ai/commits/main":
			fmt.Fprint(w, `{"sha":"aaaabbbbcccc0123456789abcdef0123456789ab","html_url":"https://github.com/franwerner/gentle-ai/commit/aaaabbbbcccc0123456789abcdef0123456789ab","commit":{"committer":{"date":"2026-08-01T00:00:00Z"}}}`)
		default:
			// Stray or misdirected request: reply 404 and let the test's
			// main-goroutine assertions decide (see simulateStrayForeignRequest).
			http.NotFound(w, r)
...
func TestCheckAll(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case contains(path, "gentle-ai"):
			release = githubRelease{TagName: "v1.5.0", HTMLURL: "https://github.com/franwerner/gentle-ai/releases/tag/v1.5.0"}
...
func TestUpdateHint(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			tool:    ToolInfo{Name: "gentle-ai"},
			profile: system.PlatformProfile{OS: "linux", PackageManager: "apt"},
			want:    "curl -fsSL https://raw.githubusercontent.com/franwerner/gentle-ai/main/scripts/install.sh | bash",
		},
		{
			name:    "gentle-ai windows",
			tool:    ToolInfo{Name: "gentle-ai"},
			profile: system.PlatformProfile{OS: "windows", PackageManager: "winget"},
			want:    "Windows binary distribution and Scoop are temporarily unavailable until publicly trusted Authenticode signing is enforced. Install/update from source with Go 1.25.10+: go install github.com/franwerner/gentle-ai/v3/cmd/gentle-ai@latest",
		},
		{
...
func TestRegistryContents(t *testing.T) {
	...
	expected := map[string]struct {
		...
		"gentle-ai":                    {owner: "franwerner", repo: "gentle-ai"},
	...
	// gentle-ai's Go module identity must stay unchanged even though Owner
	// moved to the fork above — the release and module axes are independent.
	if want := "github.com/franwerner/gentle-ai/v3/cmd/gentle-ai"; Tools[0].GoImportPath != want {
		t.Fatalf("gentle-ai GoImportPath = %q, want %q", Tools[0].GoImportPath, want)
	}
